  ...
  outputs =
    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem =
        ...
        {
          packages = {
            default = self.packages.${system}.booklog;

            booklog = rustPlatform.buildRustPackage {
              pname = "booklog";
              inherit version;
              src = lib.cleanSource ./.;
              ...
              meta = {
                ...
                homepage = "https://github.com/jnsgruk/booklog";
            ...
            booklog-container = pkgs.dockerTools.buildImage {
              name = "booklog";
              tag = version;
              created = "now";
              ...
              config = {
                Entrypoint = [
                  "${lib.getExe self.packages.${system}.booklog}"
                  "serve"
                  "--database-url"
                  "sqlite:///data/booklog.db"
                ];
                User = "1000:1000";
              };
            };
